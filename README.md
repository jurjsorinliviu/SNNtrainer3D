...
**The research paper behind the SNNtrainer3D can be read here**: https://www.mdpi.com/2076-3417/14/13/5752
...
\- 5 different types of neurons (LIF, Lapicque, Synaptic, Alpha, and "Realistic Lapicque")

\- Fully customizable network architecture

\- Integrated with the MNIST and XOR datasets
...
Jurj, S.L.; Banasaz Nouri, S.; Strutwolf, J. SNNtrainer3D: Training Spiking Neural Networks Using a User-Friendly Application with 3D Architecture Visualization Capabilities. Appl. Sci. 2024, 14, 5752. https://doi.org/10.3390/app14135752
